    ...
    return $data;
      ...
      if($_GET['city'])
      {
		...
		$weather0_2 = "<div class='weather_list'><br/>"."<table class='table table-striped table-condensed table-bordered'><br/>"
					  ."<tbody><br/>"."<tr>"."<td><b>Скорость ветра</td></b>"."<td>".$weatherArray->list[0]->wind->speed." м/с</td>"."</tr>";		  
		$weather0_3 = "<tr>"."<td><b>Влажность</td></b>"."<td>".$weatherArray->list[0]->main->humidity." %</td>"."</tr>";	
		$weather0_4 = "<tr>"."<td><b>Атмосферное давление</td></b>"."<td>".$weatherArray->list[0]->main->pressure*0.75. "мм рт. ст.</td>"."</tr>";
		$weather0_5 = "<tr>"."<td><b>Описание</td></b>"."<td>".$weatherArray->list[0]->weather[0]->description."</td>"."</tr>";
		$weather0_6 = "<tr>"."<td><b>Облачность</td></b>"."<td>".$weatherArray->list[0]->clouds->all." %</td>"."</tr>";
		$weather0_7 = "<tr>"."<td><b>Температурный диапазон</td></b>"."<td>От: ".$weatherArray->list[0]->main->temp_min."&deg;C "."До: ".$weatherArray->list[0]->main->temp_max."&deg;C</td>"."</tr>";
		$weather0_8 = "<tr>"."<td><b>Координаты</td></b>"."<td>"."[".$weatherArray->city->coord->lat.";".$weatherArray->city->coord->lon."]"."</td>"."</tr>"
...
<body onload="clock()">
											...
											for($cc=0; $cc<=$weatherArray->list[$f]; $cc++)
											{
												for($z=0; $z<=$weatherArray->list[$ff]; $z++)
												{
													for($zz=0; $zz<=$weatherArray->list[$p]; $zz++)
													{
														...
														{
															echo "<tr>";
								echo "<td>".$weatherArray->list[$q]->dt_txt."\n\n</td>";
								echo "<td>".$weatherArray->list[$d]->main->temp."\n\n</td>";
								$iconId = $weatherArray->list[$dd]->weather[0]->icon;
								echo "<td>"."<img src='http://openweathermap.org/img/w/".$iconId.".png' alt='Icon depicting current weather.'>"."\n\n</td>";
	...
	function init_map()
    {
        var myOptions = {
            zoom:12,
            center:new google.maps.LatLng($weatherArray->city->coord->lat, $weatherArray->city->coord->lon),
            mapTypeId: google.maps.MapTypeId.ROADMAP};
        
            map = new google.maps.Map(document.getElementById('map'), myOptions);
            marker = new google.maps.Marker(
                {
                    map: map,position: new google.maps.LatLng($weatherArray->city->coord->lat,$weatherArray->city->coord->lon)});
